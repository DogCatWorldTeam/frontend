...
const PetData = {
  pets: [
    { name: "강아지1", age: "2살", gender: "남", weight: "6kg", img: Dog, fav: Favorite },
    { name: "강아지2", age: "2살", gender: "남", weight: "6kg", img: Dog, fav: Favorite },
    ...
    { name: "강아지6", age: "2살", gender: "남", weight: "6kg", img: Dog, fav: Favorite },
    { name: "강아지7", age: "2살", gender: "남", weight: "6kg", img: Dog, fav: FavoriteFill },
    { name: "강아지8", age: "2살", gender: "남", weight: "6kg", img: Dog, fav: Favorite },
    { name: "강아지9", age: "2살", gender: "남", weight: "6kg", img: Dog, fav: Favorite },
